...
/*   Updated: 2023/11/05 01:52:27 by tischmid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rot_pb_buckets(t_deque *deque_a, t_deque *deque_b, int n_buckets)
{
	...
	while (deque_a->head)
	{
		deque_push_node_right(deque_b, deque_pop_right(deque_a));
	}
}
...
void	push_swap(t_deque *deque_a)
{
	...
	ft_printf("\nAfter:\n\033\13334mDEQUE A\033\133m:\n");
	deque_print(deque_a);
	ft_printf("\033\13333mDEQUE B\033\133m:\n");
	deque_print(deque_b);
}
